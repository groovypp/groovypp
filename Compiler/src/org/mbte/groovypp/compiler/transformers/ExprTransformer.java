...
import org.mbte.groovypp.compiler.transformers.AttributeExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.BinaryExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.BitwiseNegationExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.BooleanExpressionTransformer;
...
import org.mbte.groovypp.compiler.transformers.ClosureExpressionTransformer;
...
import org.mbte.groovypp.compiler.transformers.FieldExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.GStringExpressionTransformer;
...
import org.mbte.groovypp.compiler.transformers.MethodPointerExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.NamedArgumentListExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.PostfixExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.PrefixExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.PropertyExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.RangeExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.SpreadExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.TernaryExpressionTransformer;
import org.mbte.groovypp.compiler.transformers.UnaryPlusExpressionTransformer;
...
public abstract class ExprTransformer<T extends Expression> implements Opcodes {
    ...
    static {
        ...
        transformers.put(UnaryMinusExpression.class, new org.mbte.groovypp.compiler.transformers.UnaryMinusExpressionTransformer());
