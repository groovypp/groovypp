...
public class BytecodeHelper implements Opcodes {
    ...
    public void load(org.codehaus.groovy.classgen.Variable v) {
        load(v.getType(), v.getIndex());
    }

    public void store(org.codehaus.groovy.classgen.Variable v, boolean markStart) {
    ...
    public void store(org.codehaus.groovy.classgen.Variable v) {
        store(v, false);
    }
     ...
     */
    public void loadVar(org.codehaus.groovy.classgen.Variable variable) {
        ...
        if (variable.isHolder()) {
            ...
            load(variable);
            if (variable != org.codehaus.groovy.classgen.Variable.THIS_VARIABLE && variable != org.codehaus.groovy.classgen.Variable.SUPER_VARIABLE) {
     ...
     * @param variable
     */
    public void loadVar(org.codehaus.groovy.classgen.Variable variable, boolean useReferenceDirectly) {
        int index = variable.getIndex();
        if (variable.isHolder()) {
            mv.visitVarInsn(ALOAD, index);
    ...
    public void storeVar(org.codehaus.groovy.classgen.Variable variable) {
        int index = variable.getIndex();
